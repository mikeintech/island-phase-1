...
#define LOW_PRECISION`),t}function Yp(i){let t="SHADOWMAP_TYPE_BASIC";return i.shadowMapType===$o?t="SHADOWMAP_TYPE_PCF":i.shadowMapType===nl?t="SHADOWMAP_TYPE_PCF_SOFT":i.shadowMapType===un&&(t="SHADOWMAP_TYPE_VSM"),t}function Kp(i){let t="ENVMAP_TYPE_CUBE";if(i.envMap)switch(i.envMapMode){case Si:case yi:t="ENVMAP_TYPE_CUBE";break;case kr:t="ENVMAP_TYPE_CUBE_UV";break}return t}function $p(i){let t="ENVMAP_MODE_REFLECTION";if(i.envMap)switch(i.envMapMode){case yi:t="ENVMAP_MODE_REFRACTION";break}return t}function Jp(i){let t="ENVMAP_BLENDING_NONE";if(i.envMap)switch(i.combine){case Jo:t="ENVMAP_BLENDING_MULTIPLY";break;case Rl:t="ENVMAP_BLENDING_MIX";break;case Cl:t="ENVMAP_BLENDING_ADD";break}return t}function Zp(i){const t=i.envMapCubeUVHeight;if(t===null)return null;const e=Math.log2(t)-2,n=1/t;return{texelWidth:1/(3*Math.max(Math.pow(2,e),7*16)),texelHeight:n,maxMip:e}}function jp(i,t,e,n){const r=i.getContext(),s=e.defines;let a=e.vertexShader,o=e.fragmentShader;const c=Yp(e),l=Kp(e),h=$p(e),d=Jp(e),p=Zp(e),f=zp(e),g=Hp(s),_=r.createProgram();let m,u,E=e.glslVersion?"#version "+e.glslVersion+`
...
`)+`
`+u);const S=E+m+a,T=E+u+o,F=bo(r,r.VERTEX_SHADER,S),R=bo(r,r.FRAGMENT_SHADER,T);r.attachShader(_,F),r.attachShader(_,R),e.index0AttributeName!==void 0?r.bindAttribLocation(_,0,e.index0AttributeName):e.morphTargets===!0&&r.bindAttribLocation(_,0,"position"),r.linkProgram(_);function C(L){if(i.debug.checkShaderErrors){const k=r.getProgramInfoLog(_).trim(),z=r.getShaderInfoLog(F).trim(),q=r.getShaderInfoLog(R).trim();let X=!0,G=!0;if(r.getProgramParameter(_,r.LINK_STATUS)===!1)if(X=!1,typeof i.debug.onShaderError=="function")i.debug.onShaderError(r,_,F,R);else{const $=Ao(r,F,"vertex"),W=Ao(r,R,"fragment");console.error("THREE.WebGLProgram: Shader Error "+r.getError()+" - VALIDATE_STATUS "+r.getProgramParameter(_,r.VALIDATE_STATUS)+`
...
}`;function gm(i,t,e){let n=new Js;const r=new dt,s=new dt,a=new se,o=new dm({depthPacking:$l}),c=new fm,l={},h=e.maxTextureSize,d={[An]:Ie,[Ie]:An,[Pe]:Pe},p=new Cn({defines:{VSM_SAMPLES:8},uniforms:{shadow_pass:{value:null},resolution:{value:new dt},radius:{value:4}},vertexShader:pm,fragmentShader:mm}),f=p.clone();f.defines.HORIZONTAL_PASS=1;const g=new pe;g.setAttribute("position",new en(new Float32Array([-1,-1,.5,3,-1,.5,-1,3,.5]),3));const _=new Yt(g,p),m=this;this.enabled=!1,this.autoUpdate=!0,this.needsUpdate=!1,this.type=$o;let u=this.type;this.render=function(R,C,N){if(m.enabled===!1||m.autoUpdate===!1&&m.needsUpdate===!1||R.length===0)return;const y=i.getRenderTarget(),M=i.getActiveCubeFace(),L=i.getActiveMipmapLevel(),k=i.state;k.setBlending(En),k.buffers.color.setClear(1,1,1,1),k.buffers.depth.setTest(!0),k.setScissorTest(!1);const z=u!==un&&this.type===un,q=u===un&&this.type!==un;for(let X=0,G=R.length;X<G;X++){const $=R[X],W=$.shadow;if(W===void 0){console.warn("THREE.WebGLShadowMap:",$,"has no shadow.");continue}if(W.autoUpdate===!1&&W.needsUpdate===!1)continue;r.copy(W.mapSize);const at=W.getFrameExtents();if(r.multiply(at),s.copy(W.mapSize),(r.x>h||r.y>h)&&(r.x>h&&(s.x=Math.floor(h/at.x),r.x=s.x*at.x,W.mapSize.x=s.x),r.y>h&&(s.y=Math.floor(h/at.y),r.y=s.y*at.y,W.mapSize.y=s.y)),W.map===null||z===!0||q===!0){const gt=this.type!==un?{minFilter:Ge,magFilter:Ge}:{};W.map!==null&&W.map.dispose(),W.map=new $n(r.x,r.y,gt),W.map.texture.name=$.name+".shadowMap",W.camera.updateProjectionMatrix()}i.setRenderTarget(W.map),i.clear();const ft=W.getViewportCount();for(let gt=0;gt<ft;gt++){const Bt=W.getViewport(gt);a.set(s.x*Bt.x,s.y*Bt.y,s.x*Bt.z,s.y*Bt.w),k.viewport(a),W.updateMatrices($,gt),n=W.getFrustum(),T(C,N,W.camera,$,this.type)}W.isPointLightShadow!==!0&&this.type===un&&E(W,N),W.needsUpdate=!1}u=this.type,m.needsUpdate=!1,i.setRenderTarget(y,M,L)};function E(R,C){const N=t.update(_);p.defines.VSM_SAMPLES!==R.blurSamples&&(p.defines.VSM_SAMPLES=R.blurSamples,f.defines.VSM_SAMPLES=R.blurSamples,p.needsUpdate=!0,f.needsUpdate=!0),R.mapPass===null&&(R.mapPass=new $n(r.x,r.y)),p.uniforms.shadow_pass.value=R.map.texture,p.uniforms.resolution.value=R.mapSize,p.uniforms.radius.value=R.radius,i.setRenderTarget(R.mapPass),i.clear(),i.renderBufferDirect(C,null,N,p,_,null),f.uniforms.shadow_pass.value=R.mapPass.texture,f.uniforms.resolution.value=R.mapSize,f.uniforms.radius.value=R.radius,i.setRenderTarget(R.map),i.clear(),i.renderBufferDirect(C,null,N,f,_,null)}function S(R,C,N,y){let M=null;const L=N.isPointLight===!0?R.customDistanceMaterial:R.customDepthMaterial;if(L!==void 0)M=L;else if(M=N.isPointLight===!0?c:o,i.localClippingEnabled&&C.clipShadows===!0&&Array.isArray(C.clippingPlanes)&&C.clippingPlanes.length!==0||C.displacementMap&&C.displacementScale!==0||C.alphaMap&&C.alphaTest>0||C.map&&C.alphaTest>0){const k=M.uuid,z=C.uuid;let q=l[k];q===void 0&&(q={},l[k]=q);let X=q[z];X===void 0&&(X=M.clone(),q[z]=X,C.addEventListener("dispose",F)),M=X}if(M.visible=C.visible,M.wireframe=C.wireframe,y===un?M.side=C.shadowSide!==null?C.shadowSide:C.side:M.side=C.shadowSide!==null?C.shadowSide:d[C.side],M.alphaMap=C.alphaMap,M.alphaTest=C.alphaTest,M.map=C.map,M.clipShadows=C.clipShadows,M.clippingPlanes=C.clippingPlanes,M.clipIntersection=C.clipIntersection,M.displacementMap=C.displacementMap,M.displacementScale=C.displacementScale,M.displacementBias=C.displacementBias,M.wireframeLinewidth=C.wireframeLinewidth,M.linewidth=C.linewidth,N.isPointLight===!0&&M.isMeshDistanceMaterial===!0){const k=i.properties.get(M);k.light=N}return M}function T(R,C,N,y,M){if(R.visible===!1)return;if(R.layers.test(C.layers)&&(R.isMesh||R.isLine||R.isPoints)&&(R.castShadow||R.receiveShadow&&M===un)&&(!R.frustumCulled||n.intersectsObject(R))){R.modelViewMatrix.multiplyMatrices(N.matrixWorldInverse,R.matrixWorld);const z=t.update(R),q=R.material;if(Array.isArray(q)){const X=z.groups;for(let G=0,$=X.length;G<$;G++){const W=X[G],at=q[W.materialIndex];if(at&&at.visible){const ft=S(R,at,y,M);R.onBeforeShadow(i,R,C,N,z,ft,W),i.renderBufferDirect(N,null,z,ft,R,W),R.onAfterShadow(i,R,C,N,z,ft,W)}}}else if(q.visible){const X=S(R,q,y,M);R.onBeforeShadow(i,R,C,N,z,X,null),i.renderBufferDirect(N,null,z,X,R,null),R.onAfterShadow(i,R,C,N,z,X,null)}}const k=R.children;for(let z=0,q=k.length;z<q;z++)T(k[z],C,N,y,M)}function F(R){R.target.removeEventListener("dispose",F);for(const N in l){const y=l[N],M=R.target.uuid;M in y&&(y[M].dispose(),delete y[M])}}}function _m(i){function t(){let P=!1;const ht=new se;let Y=null;const K=new se(0,0,0,0);return{setMask:function(nt){Y!==nt&&!P&&(i.colorMask(nt,nt,nt,nt),Y=nt)},setLocked:function(nt){P=nt},setClear:function(nt,wt,Kt,ue,_e){_e===!0&&(nt*=ue,wt*=ue,Kt*=ue),ht.set(nt,wt,Kt,ue),K.equals(ht)===!1&&(i.clearColor(nt,wt,Kt,ue),K.copy(ht))},reset:function(){P=!1,Y=null,K.set(-1,0,0,0)}}}function e(){let P=!1,ht=null,Y=null,K=null;return{setTest:function(nt){nt?pt(i.DEPTH_TEST):it(i.DEPTH_TEST)},setMask:function(nt){ht!==nt&&!P&&(i.depthMask(nt),ht=nt)},setFunc:function(nt){if(Y!==nt){switch(nt){case Sl:i.depthFunc(i.NEVER);break;case yl:i.depthFunc(i.ALWAYS);break;case El:i.depthFunc(i.LESS);break;case Lr:i.depthFunc(i.LEQUAL);break;case Tl:i.depthFunc(i.EQUAL);break;case bl:i.depthFunc(i.GEQUAL);break;case Al:i.depthFunc(i.GREATER);break;case wl:i.depthFunc(i.NOTEQUAL);break;default:i.depthFunc(i.LEQUAL)}Y=nt}},setLocked:function(nt){P=nt},setClear:function(nt){K!==nt&&(i.clearDepth(nt),K=nt)},reset:function(){P=!1,ht=null,Y=null,K=null}}}function n(){let P=!1,ht=null,Y=null,K=null,nt=null,wt=null,Kt=null,ue=null,_e=null;return{setTest:function(te){P||(te?pt(i.STENCIL_TEST):it(i.STENCIL_TEST))},setMask:function(te){ht!==te&&!P&&(i.stencilMask(te),ht=te)},setFunc:function(te,Ke,$e){(Y!==te||K!==Ke||nt!==$e)&&(i.stencilFunc(te,Ke,$e),Y=te,K=Ke,nt=$e)},setOp:function(te,Ke,$e){(wt!==te||Kt!==Ke||ue!==$e)&&(i.stencilOp(te,Ke,$e),wt=te,Kt=Ke,ue=$e)},setLocked:function(te){P=te},setClear:function(te){_e!==te&&(i.clearStencil(te),_e=te)},reset:function(){P=!1,ht=null,Y=null,K=null,nt=null,wt=null,Kt=null,ue=null,_e=null}}}const r=new t,s=new e,a=new n,o=new WeakMap,c=new WeakMap;let l={},h={},d=new WeakMap,p=[],f=null,g=!1,_=null,m=null,u=null,E=null,S=null,T=null,F=null,R=new Ot(0,0,0),C=0,N=!1,y=null,M=null,L=null,k=null,z=null;const q=i.getParameter(i.MAX_COMBINED_TEXTURE_IMAGE_UNITS);let X=!1,G=0;const $=i.getParameter(i.VERSION);$.indexOf("WebGL")!==-1?(G=parseFloat(/^WebGL (\d)/.exec($)[1]),X=G>=1):$.indexOf("OpenGL ES")!==-1&&(G=parseFloat(/^OpenGL ES (\d)/.exec($)[1]),X=G>=2);let W=null,at={};const ft=i.getParameter(i.SCISSOR_BOX),gt=i.getParameter(i.VIEWPORT),Bt=new se().fromArray(ft),zt=new se().fromArray(gt);function V(P,ht,Y,K){const nt=new Uint8Array(4),wt=i.createTexture();i.bindTexture(P,wt),i.texParameteri(P,i.TEXTURE_MIN_FILTER,i.NEAREST),i.texParameteri(P,i.TEXTURE_MAG_FILTER,i.NEAREST);for(let Kt=0;Kt<Y;Kt++)P===i.TEXTURE_3D||P===i.TEXTURE_2D_ARRAY?i.texImage3D(ht,0,i.RGBA,1,1,K,0,i.RGBA,i.UNSIGNED_BYTE,nt):i.texImage2D(ht+Kt,0,i.RGBA,1,1,0,i.RGBA,i.UNSIGNED_BYTE,nt);return wt}const Q={};Q[i.TEXTURE_2D]=V(i.TEXTURE_2D,i.TEXTURE_2D,1),Q[i.TEXTURE_CUBE_MAP]=V(i.TEXTURE_CUBE_MAP,i.TEXTURE_CUBE_MAP_POSITIVE_X,6),Q[i.TEXTURE_2D_ARRAY]=V(i.TEXTURE_2D_ARRAY,i.TEXTURE_2D_ARRAY,1,1),Q[i.TEXTURE_3D]=V(i.TEXTURE_3D,i.TEXTURE_3D,1,1),r.setClear(0,0,0,1),s.setClear(1),a.setClear(0),pt(i.DEPTH_TEST),s.setFunc(Lr),Et(!1),qt(fa),pt(i.CULL_FACE),Gt(En);function pt(P){l[P]!==!0&&(i.enable(P),l[P]=!0)}function it(P){l[P]!==!1&&(i.disable(P),l[P]=!1)}function Ut(P,ht){return h[P]!==ht?(i.bindFramebuffer(P,ht),h[P]=ht,P===i.DRAW_FRAMEBUFFER&&(h[i.FRAMEBUFFER]=ht),P===i.FRAMEBUFFER&&(h[i.DRAW_FRAMEBUFFER]=ht),!0):!1}function Rt(P,ht){let Y=p,K=!1;if(P){Y=d.get(ht),Y===void 0&&(Y=[],d.set(ht,Y));const nt=P.textures;if(Y.length!==nt.length||Y[0]!==i.COLOR_ATTACHMENT0){for(let wt=0,Kt=nt.length;wt<Kt;wt++)Y[wt]=i.COLOR_ATTACHMENT0+wt;Y.length=nt.length,K=!0}}else Y[0]!==i.BACK&&(Y[0]=i.BACK,K=!0);K&&i.drawBuffers(Y)}function Xt(P){return f!==P?(i.useProgram(P),f=P,!0):!1}const D={[Vn]:i.FUNC_ADD,[rl]:i.FUNC_SUBTRACT,[sl]:i.FUNC_REVERSE_SUBTRACT};D[al]=i.MIN,D[ol]=i.MAX;const Wt={[cl]:i.ZERO,[ll]:i.ONE,[hl]:i.SRC_COLOR,[zs]:i.SRC_ALPHA,[gl]:i.SRC_ALPHA_SATURATE,[pl]:i.DST_COLOR,[dl]:i.DST_ALPHA,[ul]:i.ONE_MINUS_SRC_COLOR,[Hs]:i.ONE_MINUS_SRC_ALPHA,[ml]:i.ONE_MINUS_DST_COLOR,[fl]:i.ONE_MINUS_DST_ALPHA,[_l]:i.CONSTANT_COLOR,[vl]:i.ONE_MINUS_CONSTANT_COLOR,[xl]:i.CONSTANT_ALPHA,[Ml]:i.ONE_MINUS_CONSTANT_ALPHA};function Gt(P,ht,Y,K,nt,wt,Kt,ue,_e,te){if(P===En){g===!0&&(it(i.BLEND),g=!1);return}if(g===!1&&(pt(i.BLEND),g=!0),P!==il){if(P!==_||te!==N){if((m!==Vn||S!==Vn)&&(i.blendEquation(i.FUNC_ADD),m=Vn,S=Vn),te)switch(P){case vi:i.blendFuncSeparate(i.ONE,i.ONE_MINUS_SRC_ALPHA,i.ONE,i.ONE_MINUS_SRC_ALPHA);break;case Bs:i.blendFunc(i.ONE,i.ONE);break;case pa:i.blendFuncSeparate(i.ZERO,i.ONE_MINUS_SRC_COLOR,i.ZERO,i.ONE);break;case ma:i.blendFuncSeparate(i.ZERO,i.SRC_COLOR,i.ZERO,i.SRC_ALPHA);break;default:console.error("THREE.WebGLState: Invalid blending: ",P);break}else switch(P){case vi:i.blendFuncSeparate(i.SRC_ALPHA,i.ONE_MINUS_SRC_ALPHA,i.ONE,i.ONE_MINUS_SRC_ALPHA);break;case Bs:i.blendFunc(i.SRC_ALPHA,i.ONE);break;case pa:i.blendFuncSeparate(i.ZERO,i.ONE_MINUS_SRC_COLOR,i.ZERO,i.ONE);break;case ma:i.blendFunc(i.ZERO,i.SRC_COLOR);break;default:console.error("THREE.WebGLState: Invalid blending: ",P);break}u=null,E=null,T=null,F=null,R.set(0,0,0),C=0,_=P,N=te}return}nt=nt||ht,wt=wt||Y,Kt=Kt||K,(ht!==m||nt!==S)&&(i.blendEquationSeparate(D[ht],D[nt]),m=ht,S=nt),(Y!==u||K!==E||wt!==T||Kt!==F)&&(i.blendFuncSeparate(Wt[Y],Wt[K],Wt[wt],Wt[Kt]),u=Y,E=K,T=wt,F=Kt),(ue.equals(R)===!1||_e!==C)&&(i.blendColor(ue.r,ue.g,ue.b,_e),R.copy(ue),C=_e),_=P,N=!1}function oe(P,ht){P.side===Pe?it(i.CULL_FACE):pt(i.CULL_FACE);let Y=P.side===Ie;ht&&(Y=!Y),Et(Y),P.blending===vi&&P.transparent===!1?Gt(En):Gt(P.blending,P.blendEquation,P.blendSrc,P.blendDst,P.blendEquationAlpha,P.blendSrcAlpha,P.blendDstAlpha,P.blendColor,P.blendAlpha,P.premultipliedAlpha),s.setFunc(P.depthFunc),s.setTest(P.depthTest),s.setMask(P.depthWrite),r.setMask(P.colorWrite);const K=P.stencilWrite;a.setTest(K),K&&(a.setMask(P.stencilWriteMask),a.setFunc(P.stencilFunc,P.stencilRef,P.stencilFuncMask),a.setOp(P.stencilFail,P.stencilZFail,P.stencilZPass)),Ct(P.polygonOffset,P.polygonOffsetFactor,P.polygonOffsetUnits),P.alphaToCoverage===!0?pt(i.SAMPLE_ALPHA_TO_COVERAGE):it(i.SAMPLE_ALPHA_TO_COVERAGE)}function Et(P){y!==P&&(P?i.frontFace(i.CW):i.frontFace(i.CCW),y=P)}function qt(P){P!==tl?(pt(i.CULL_FACE),P!==M&&(P===fa?i.cullFace(i.BACK):P===el?i.cullFace(i.FRONT):i.cullFace(i.FRONT_AND_BACK))):it(i.CULL_FACE),M=P}function Ft(P){P!==L&&(X&&i.lineWidth(P),L=P)}function Ct(P,ht,Y){P?(pt(i.POLYGON_OFFSET_FILL),(k!==ht||z!==Y)&&(i.polygonOffset(ht,Y),k=ht,z=Y)):it(i.POLYGON_OFFSET_FILL)}function de(P){P?pt(i.SCISSOR_TEST):it(i.SCISSOR_TEST)}function w(P){P===void 0&&(P=i.TEXTURE0+q-1),W!==P&&(i.activeTexture(P),W=P)}function v(P,ht,Y){Y===void 0&&(W===null?Y=i.TEXTURE0+q-1:Y=W);let K=at[Y];K===void 0&&(K={type:void 0,texture:void 0},at[Y]=K),(K.type!==P||K.texture!==ht)&&(W!==Y&&(i.activeTexture(Y),W=Y),i.bindTexture(P,ht||Q[P]),K.type=P,K.texture=ht)}function H(){const P=at[W];P!==void 0&&P.type!==void 0&&(i.bindTexture(P.type,null),P.type=void 0,P.texture=void 0)}function J(){try{i.compressedTexImage2D.apply(i,arguments)}catch(P){console.error("THREE.WebGLState:",P)}}function Z(){try{i.compressedTexImage3D.apply(i,arguments)}catch(P){console.error("THREE.WebGLState:",P)}}function j(){try{i.texSubImage2D.apply(i,arguments)}catch(P){console.error("THREE.WebGLState:",P)}}function St(){try{i.texSubImage3D.apply(i,arguments)}catch(P){console.error("THREE.WebGLState:",P)}}function ot(){try{i.compressedTexSubImage2D.apply(i,arguments)}catch(P){console.error("THREE.WebGLState:",P)}}function ct(){try{i.compressedTexSubImage3D.apply(i,arguments)}catch(P){console.error("THREE.WebGLState:",P)}}function It(){try{i.texStorage2D.apply(i,arguments)}catch(P){console.error("THREE.WebGLState:",P)}}function tt(){try{i.texStorage3D.apply(i,arguments)}catch(P){console.error("THREE.WebGLState:",P)}}function vt(){try{i.texImage2D.apply(i,arguments)}catch(P){console.error("THREE.WebGLState:",P)}}function Ht(){try{i.texImage3D.apply(i,arguments)}catch(P){console.error("THREE.WebGLState:",P)}}function At(P){Bt.equals(P)===!1&&(i.scissor(P.x,P.y,P.z,P.w),Bt.copy(P))}function lt(P){zt.equals(P)===!1&&(i.viewport(P.x,P.y,P.z,P.w),zt.copy(P))}function Nt(P,ht){let Y=c.get(ht);Y===void 0&&(Y=new WeakMap,c.set(ht,Y));let K=Y.get(P);K===void 0&&(K=i.getUniformBlockIndex(ht,P.name),Y.set(P,K))}function Vt(P,ht){const K=c.get(ht).get(P);o.get(ht)!==K&&(i.uniformBlockBinding(ht,K,P.__bindingPointIndex),o.set(ht,K))}function he(){i.disable(i.BLEND),i.disable(i.CULL_FACE),i.disable(i.DEPTH_TEST),i.disable(i.POLYGON_OFFSET_FILL),i.disable(i.SCISSOR_TEST),i.disable(i.STENCIL_TEST),i.disable(i.SAMPLE_ALPHA_TO_COVERAGE),i.blendEquation(i.FUNC_ADD),i.blendFunc(i.ONE,i.ZERO),i.blendFuncSeparate(i.ONE,i.ZERO,i.ONE,i.ZERO),i.blendColor(0,0,0,0),i.colorMask(!0,!0,!0,!0),i.clearColor(0,0,0,0),i.depthMask(!0),i.depthFunc(i.LESS),i.clearDepth(1),i.stencilMask(4294967295),i.stencilFunc(i.ALWAYS,0,4294967295),i.stencilOp(i.KEEP,i.KEEP,i.KEEP),i.clearStencil(0),i.cullFace(i.BACK),i.frontFace(i.CCW),i.polygonOffset(0,0),i.activeTexture(i.TEXTURE0),i.bindFramebuffer(i.FRAMEBUFFER,null),i.bindFramebuffer(i.DRAW_FRAMEBUFFER,null),i.bindFramebuffer(i.READ_FRAMEBUFFER,null),i.useProgram(null),i.lineWidth(1),i.scissor(0,0,i.canvas.width,i.canvas.height),i.viewport(0,0,i.canvas.width,i.canvas.height),l={},W=null,at={},h={},d=new WeakMap,p=[],f=null,g=!1,_=null,m=null,u=null,E=null,S=null,T=null,F=null,R=new Ot(0,0,0),C=0,N=!1,y=null,M=null,L=null,k=null,z=null,Bt.set(0,0,i.canvas.width,i.canvas.height),zt.set(0,0,i.canvas.width,i.canvas.height),r.reset(),s.reset(),a.reset()}return{buffers:{color:r,depth:s,stencil:a},enable:pt,disable:it,bindFramebuffer:Ut,drawBuffers:Rt,useProgram:Xt,setBlending:Gt,setMaterial:oe,setFlipSided:Et,setCullFace:qt,setLineWidth:Ft,setPolygonOffset:Ct,setScissorTest:de,activeTexture:w,bindTexture:v,unbindTexture:H,compressedTexImage2D:J,compressedTexImage3D:Z,texImage2D:vt,texImage3D:Ht,updateUBOMapping:Nt,uniformBlockBinding:Vt,texStorage2D:It,texStorage3D:tt,texSubImage2D:j,texSubImage3D:St,compressedTexSubImage2D:ot,compressedTexSubImage3D:ct,scissor:At,viewport:lt,reset:he}}function vm(i,t,e,n,r,s,a){const o=t.has("WEBGL_multisampled_render_to_texture")?t.get("WEBGL_multisampled_render_to_texture"):null,c=typeof navigator>"u"?!1:/OculusBrowser/g.test(navigator.userAgent),l=new dt,h=new WeakMap;let d;const p=new WeakMap;let f=!1;try{f=typeof OffscreenCanvas<"u"&&new OffscreenCanvas(1,1).getContext("2d")!==null}catch{}function g(w,v){return f?new OffscreenCanvas(w,v):Or("canvas")}function _(w,v,H){let J=1;const Z=de(w);if((Z.width>H||Z.height>H)&&(J=H/Math.max(Z.width,Z.height)),J<1)if(typeof HTMLImageElement<"u"&&w instanceof HTMLImageElement||typeof HTMLCanvasElement<"u"&&w instanceof HTMLCanvasElement||typeof ImageBitmap<"u"&&w instanceof ImageBitmap||typeof VideoFrame<"u"&&w instanceof VideoFrame){const j=Math.floor(J*Z.width),St=Math.floor(J*Z.height);d===void 0&&(d=g(j,St));const ot=v?g(j,St):d;return ot.width=j,ot.height=St,ot.getContext("2d").drawImage(w,0,0,j,St),console.warn("THREE.WebGLRenderer: Texture has been resized from ("+Z.width+"x"+Z.height+") to ("+j+"x"+St+")."),ot}else return"data"in w&&console.warn("THREE.WebGLRenderer: Image in DataTexture is too big ("+Z.width+"x"+Z.height+")."),w;return w}function m(w){return w.generateMipmaps&&w.minFilter!==Ge&&w.minFilter!==Ye}function u(w){i.generateMipmap(w)}function E(w,v,H,J,Z=!1){if(w!==null){if(i[w]!==void 0)return i[w];console.warn("THREE.WebGLRenderer: Attempt to use non-existing WebGL internal format '"+w+"'")}let j=v;if(v===i.RED&&(H===i.FLOAT&&(j=i.R32F),H===i.HALF_FLOAT&&(j=i.R16F),H===i.UNSIGNED_BYTE&&(j=i.R8)),v===i.RED_INTEGER&&(H===i.UNSIGNED_BYTE&&(j=i.R8UI),H===i.UNSIGNED_SHORT&&(j=i.R16UI),H===i.UNSIGNED_INT&&(j=i.R32UI),H===i.BYTE&&(j=i.R8I),H===i.SHORT&&(j=i.R16I),H===i.INT&&(j=i.R32I)),v===i.RG&&(H===i.FLOAT&&(j=i.RG32F),H===i.HALF_FLOAT&&(j=i.RG16F),H===i.UNSIGNED_BYTE&&(j=i.RG8)),v===i.RG_INTEGER&&(H===i.UNSIGNED_BYTE&&(j=i.RG8UI),H===i.UNSIGNED_SHORT&&(j=i.RG16UI),H===i.UNSIGNED_INT&&(j=i.RG32UI),H===i.BYTE&&(j=i.RG8I),H===i.SHORT&&(j=i.RG16I),H===i.INT&&(j=i.RG32I)),v===i.RGB&&H===i.UNSIGNED_INT_5_9_9_9_REV&&(j=i.RGB9_E5),v===i.RGBA){const St=Z?Ur:jt.getTransfer(J);H===i.FLOAT&&(j=i.RGBA32F),H===i.HALF_FLOAT&&(j=i.RGBA16F),H===i.UNSIGNED_BYTE&&(j=St===ie?i.SRGB8_ALPHA8:i.RGBA8),H===i.UNSIGNED_SHORT_4_4_4_4&&(j=i.RGBA4),H===i.UNSIGNED_SHORT_5_5_5_1&&(j=i.RGB5_A1)}return(j===i.R16F||j===i.R32F||j===i.RG16F||j===i.RG32F||j===i.RGBA16F||j===i.RGBA32F)&&t.get("EXT_color_buffer_float"),j}function S(w,v){let H;return w?v===null||v===Ei||v===Ti?H=i.DEPTH24_STENCIL8:v===yn?H=i.DEPTH32F_STENCIL8:v===Dr&&(H=i.DEPTH24_STENCIL8,console.warn("DepthTexture: 16 bit depth attachment is not supported with stencil. Using 24-bit attachment.")):v===null||v===Ei||v===Ti?H=i.DEPTH_COMPONENT24:v===yn?H=i.DEPTH_COMPONENT32F:v===Dr&&(H=i.DEPTH_COMPONENT16),H}function T(w,v){return m(w)===!0||w.isFramebufferTexture&&w.minFilter!==Ge&&w.minFilter!==Ye?Math.log2(Math.max(v.width,v.height))+1:w.mipmaps!==void 0&&w.mipmaps.length>0?w.mipmaps.length:w.isCompressedTexture&&Array.isArray(w.image)?v.mipmaps.length:1}function F(w){const v=w.target;v.removeEventListener("dispose",F),C(v),v.isVideoTexture&&h.delete(v)}function R(w){const v=w.target;v.removeEventListener("dispose",R),y(v)}function C(w){const v=n.get(w);if(v.__webglInit===void 0)return;const H=w.source,J=p.get(H);if(J){const Z=J[v.__cacheKey];Z.usedTimes--,Z.usedTimes===0&&N(w),Object.keys(J).length===0&&p.delete(H)}n.remove(w)}function N(w){const v=n.get(w);i.deleteTexture(v.__webglTexture);const H=w.source,J=p.get(H);delete J[v.__cacheKey],a.memory.textures--}function y(w){const v=n.get(w);if(w.depthTexture&&w.depthTexture.dispose(),w.isWebGLCubeRenderTarget)for(let J=0;J<6;J++){if(Array.isArray(v.__webglFramebuffer[J]))for(let Z=0;Z<v.__webglFramebuffer[J].length;Z++)i.deleteFramebuffer(v.__webglFramebuffer[J][Z]);else i.deleteFramebuffer(v.__webglFramebuffer[J]);v.__webglDepthbuffer&&i.deleteRenderbuffer(v.__webglDepthbuffer[J])}else{if(Array.isArray(v.__webglFramebuffer))for(let J=0;J<v.__webglFramebuffer.length;J++)i.deleteFramebuffer(v.__webglFramebuffer[J]);else i.deleteFramebuffer(v.__webglFramebuffer);if(v.__webglDepthbuffer&&i.deleteRenderbuffer(v.__webglDepthbuffer),v.__webglMultisampledFramebuffer&&i.deleteFramebuffer(v.__webglMultisampledFramebuffer),v.__webglColorRenderbuffer)for(let J=0;J<v.__webglColorRenderbuffer.length;J++)v.__webglColorRenderbuffer[J]&&i.deleteRenderbuffer(v.__webglColorRenderbuffer[J]);v.__webglDepthRenderbuffer&&i.deleteRenderbuffer(v.__webglDepthRenderbuffer)}const H=w.textures;for(let J=0,Z=H.length;J<Z;J++){const j=n.get(H[J]);j.__webglTexture&&(i.deleteTexture(j.__webglTexture),a.memory.textures--),n.remove(H[J])}n.remove(w)}let M=0;function L(){M=0}function k(){const w=M;return w>=r.maxTextures&&console.warn("THREE.WebGLTextures: Trying to use "+w+" texture units while this GPU supports only "+r.maxTextures),M+=1,w}function z(w){const v=[];return v.push(w.wrapS),v.push(w.wrapT),v.push(w.wrapR||0),v.push(w.magFilter),v.push(w.minFilter),v.push(w.anisotropy),v.push(w.internalFormat),v.push(w.format),v.push(w.type),v.push(w.generateMipmaps),v.push(w.premultiplyAlpha),v.push(w.flipY),v.push(w.unpackAlignment),v.push(w.colorSpace),v.join()}function q(w,v){const H=n.get(w);if(w.isVideoTexture&&Ft(w),w.isRenderTargetTexture===!1&&w.version>0&&H.__version!==w.version){const J=w.image;if(J===null)console.warn("THREE.WebGLRenderer: Texture marked for update but no image data found.");else if(J.complete===!1)console.warn("THREE.WebGLRenderer: Texture marked for update but image is incomplete");else{zt(H,w,v);return}}e.bindTexture(i.TEXTURE_2D,H.__webglTexture,i.TEXTURE0+v)}function X(w,v){const H=n.get(w);if(w.version>0&&H.__version!==w.version){zt(H,w,v);return}e.bindTexture(i.TEXTURE_2D_ARRAY,H.__webglTexture,i.TEXTURE0+v)}function G(w,v){const H=n.get(w);if(w.version>0&&H.__version!==w.version){zt(H,w,v);return}e.bindTexture(i.TEXTURE_3D,H.__webglTexture,i.TEXTURE0+v)}function $(w,v){const H=n.get(w);if(w.version>0&&H.__version!==w.version){V(H,w,v);return}e.bindTexture(i.TEXTURE_CUBE_MAP,H.__webglTexture,i.TEXTURE0+v)}const W={[Vs]:i.REPEAT,[Xn]:i.CLAMP_TO_EDGE,[Ws]:i.MIRRORED_REPEAT},at={[Ge]:i.NEAREST,[Ol]:i.NEAREST_MIPMAP_NEAREST,[nr]:i.NEAREST_MIPMAP_LINEAR,[Ye]:i.LINEAR,[Qr]:i.LINEAR_MIPMAP_NEAREST,[qn]:i.LINEAR_MIPMAP_LINEAR},ft={[Zl]:i.NEVER,[ih]:i.ALWAYS,[jl]:i.LESS,[sc]:i.LEQUAL,[Ql]:i.EQUAL,[nh]:i.GEQUAL,[th]:i.GREATER,[eh]:i.NOTEQUAL};function gt(w,v){if(v.type===yn&&t.has("OES_texture_float_linear")===!1&&(v.magFilter===Ye||v.magFilter===Qr||v.magFilter===nr||v.magFilter===qn||v.minFilter===Ye||v.minFilter===Qr||v.minFilter===nr||v.minFilter===qn)&&console.warn("THREE.WebGLRenderer: Unable to use linear filtering with floating point textures. OES_texture_float_linear not supported on this device."),i.texParameteri(w,i.TEXTURE_WRAP_S,W[v.wrapS]),i.texParameteri(w,i.TEXTURE_WRAP_T,W[v.wrapT]),(w===i.TEXTURE_3D||w===i.TEXTURE_2D_ARRAY)&&i.texParameteri(w,i.TEXTURE_WRAP_R,W[v.wrapR]),i.texParameteri(w,i.TEXTURE_MAG_FILTER,at[v.magFilter]),i.texParameteri(w,i.TEXTURE_MIN_FILTER,at[v.minFilter]),v.compareFunction&&(i.texParameteri(w,i.TEXTURE_COMPARE_MODE,i.COMPARE_REF_TO_TEXTURE),i.texParameteri(w,i.TEXTURE_COMPARE_FUNC,ft[v.compareFunction])),t.has("EXT_texture_filter_anisotropic")===!0){if(v.magFilter===Ge||v.minFilter!==nr&&v.minFilter!==qn||v.type===yn&&t.has("OES_texture_float_linear")===!1)return;if(v.anisotropy>1||n.get(v).__currentAnisotropy){const H=t.get("EXT_texture_filter_anisotropic");i.texParameterf(w,H.TEXTURE_MAX_ANISOTROPY_EXT,Math.min(v.anisotropy,r.getMaxAnisotropy())),n.get(v).__currentAnisotropy=v.anisotropy}}}function Bt(w,v){let H=!1;w.__webglInit===void 0&&(w.__webglInit=!0,v.addEventListener("dispose",F));const J=v.source;let Z=p.get(J);Z===void 0&&(Z={},p.set(J,Z));const j=z(v);if(j!==w.__cacheKey){Z[j]===void 0&&(Z[j]={texture:i.createTexture(),usedTimes:0},a.memory.textures++,H=!0),Z[j].usedTimes++;const St=Z[w.__cacheKey];St!==void 0&&(Z[w.__cacheKey].usedTimes--,St.usedTimes===0&&N(v)),w.__cacheKey=j,w.__webglTexture=Z[j].texture}return H}function zt(w,v,H){let J=i.TEXTURE_2D;(v.isDataArrayTexture||v.isCompressedArrayTexture)&&(J=i.TEXTURE_2D_ARRAY),v.isData3DTexture&&(J=i.TEXTURE_3D);const Z=Bt(w,v),j=v.source;e.bindTexture(J,w.__webglTexture,i.TEXTURE0+H);const St=n.get(j);if(j.version!==St.__version||Z===!0){e.activeTexture(i.TEXTURE0+H);const ot=jt.getPrimaries(jt.workingColorSpace),ct=v.colorSpace===Sn?null:jt.getPrimaries(v.colorSpace),It=v.colorSpace===Sn||ot===ct?i.NONE:i.BROWSER_DEFAULT_WEBGL;i.pixelStorei(i.UNPACK_FLIP_Y_WEBGL,v.flipY),i.pixelStorei(i.UNPACK_PREMULTIPLY_ALPHA_WEBGL,v.premultiplyAlpha),i.pixelStorei(i.UNPACK_ALIGNMENT,v.unpackAlignment),i.pixelStorei(i.UNPACK_COLORSPACE_CONVERSION_WEBGL,It);let tt=_(v.image,!1,r.maxTextureSize);tt=Ct(v,tt);const vt=s.convert(v.format,v.colorSpace),Ht=s.convert(v.type);let At=E(v.internalFormat,vt,Ht,v.colorSpace,v.isVideoTexture);gt(J,v);let lt;const Nt=v.mipmaps,Vt=v.isVideoTexture!==!0,he=St.__version===void 0||Z===!0,P=j.dataReady,ht=T(v,tt);if(v.isDepthTexture)At=S(v.format===bi,v.type),he&&(Vt?e.texStorage2D(i.TEXTURE_2D,1,At,tt.width,tt.height):e.texImage2D(i.TEXTURE_2D,0,At,tt.width,tt.height,0,vt,Ht,null));else if(v.isDataTexture)if(Nt.length>0){Vt&&he&&e.texStorage2D(i.TEXTURE_2D,ht,At,Nt[0].width,Nt[0].height);for(let Y=0,K=Nt.length;Y<K;Y++)lt=Nt[Y],Vt?P&&e.texSubImage2D(i.TEXTURE_2D,Y,0,0,lt.width,lt.height,vt,Ht,lt.data):e.texImage2D(i.TEXTURE_2D,Y,At,lt.width,lt.height,0,vt,Ht,lt.data);v.generateMipmaps=!1}else Vt?(he&&e.texStorage2D(i.TEXTURE_2D,ht,At,tt.width,tt.height),P&&e.texSubImage2D(i.TEXTURE_2D,0,0,0,tt.width,tt.height,vt,Ht,tt.data)):e.texImage2D(i.TEXTURE_2D,0,At,tt.width,tt.height,0,vt,Ht,tt.data);else if(v.isCompressedTexture)if(v.isCompressedArrayTexture){Vt&&he&&e.texStorage3D(i.TEXTURE_2D_ARRAY,ht,At,Nt[0].width,Nt[0].height,tt.depth);for(let Y=0,K=Nt.length;Y<K;Y++)if(lt=Nt[Y],v.format!==Qe)if(vt!==null)if(Vt){if(P)if(v.layerUpdates.size>0){for(const nt of v.layerUpdates){const wt=lt.width*lt.height;e.compressedTexSubImage3D(i.TEXTURE_2D_ARRAY,Y,0,0,nt,lt.width,lt.height,1,vt,lt.data.slice(wt*nt,wt*(nt+1)),0,0)}v.clearLayerUpdates()}else e.compressedTexSubImage3D(i.TEXTURE_2D_ARRAY,Y,0,0,0,lt.width,lt.height,tt.depth,vt,lt.data,0,0)}else e.compressedTexImage3D(i.TEXTURE_2D_ARRAY,Y,At,lt.width,lt.height,tt.depth,0,lt.data,0,0);else console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()");else Vt?P&&e.texSubImage3D(i.TEXTURE_2D_ARRAY,Y,0,0,0,lt.width,lt.height,tt.depth,vt,Ht,lt.data):e.texImage3D(i.TEXTURE_2D_ARRAY,Y,At,lt.width,lt.height,tt.depth,0,vt,Ht,lt.data)}else{Vt&&he&&e.texStorage2D(i.TEXTURE_2D,ht,At,Nt[0].width,Nt[0].height);for(let Y=0,K=Nt.length;Y<K;Y++)lt=Nt[Y],v.format!==Qe?vt!==null?Vt?P&&e.compressedTexSubImage2D(i.TEXTURE_2D,Y,0,0,lt.width,lt.height,vt,lt.data):e.compressedTexImage2D(i.TEXTURE_2D,Y,At,lt.width,lt.height,0,lt.data):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()"):Vt?P&&e.texSubImage2D(i.TEXTURE_2D,Y,0,0,lt.width,lt.height,vt,Ht,lt.data):e.texImage2D(i.TEXTURE_2D,Y,At,lt.width,lt.height,0,vt,Ht,lt.data)}else if(v.isDataArrayTexture)if(Vt){if(he&&e.texStorage3D(i.TEXTURE_2D_ARRAY,ht,At,tt.width,tt.height,tt.depth),P)if(v.layerUpdates.size>0){let Y;switch(Ht){case i.UNSIGNED_BYTE:switch(vt){case i.ALPHA:Y=1;break;case i.LUMINANCE:Y=1;break;case i.LUMINANCE_ALPHA:Y=2;break;case i.RGB:Y=3;break;case i.RGBA:Y=4;break;default:throw new Error(`Unknown texel size for format ${vt}.`)}break;case i.UNSIGNED_SHORT_4_4_4_4:case i.UNSIGNED_SHORT_5_5_5_1:case i.UNSIGNED_SHORT_5_6_5:Y=1;break;default:throw new Error(`Unknown texel size for type ${Ht}.`)}const K=tt.width*tt.height*Y;for(const nt of v.layerUpdates)e.texSubImage3D(i.TEXTURE_2D_ARRAY,0,0,0,nt,tt.width,tt.height,1,vt,Ht,tt.data.slice(K*nt,K*(nt+1)));v.clearLayerUpdates()}else e.texSubImage3D(i.TEXTURE_2D_ARRAY,0,0,0,0,tt.width,tt.height,tt.depth,vt,Ht,tt.data)}else e.texImage3D(i.TEXTURE_2D_ARRAY,0,At,tt.width,tt.height,tt.depth,0,vt,Ht,tt.data);else if(v.isData3DTexture)Vt?(he&&e.texStorage3D(i.TEXTURE_3D,ht,At,tt.width,tt.height,tt.depth),P&&e.texSubImage3D(i.TEXTURE_3D,0,0,0,0,tt.width,tt.height,tt.depth,vt,Ht,tt.data)):e.texImage3D(i.TEXTURE_3D,0,At,tt.width,tt.height,tt.depth,0,vt,Ht,tt.data);else if(v.isFramebufferTexture){if(he)if(Vt)e.texStorage2D(i.TEXTURE_2D,ht,At,tt.width,tt.height);else{let Y=tt.width,K=tt.height;for(let nt=0;nt<ht;nt++)e.texImage2D(i.TEXTURE_2D,nt,At,Y,K,0,vt,Ht,null),Y>>=1,K>>=1}}else if(Nt.length>0){if(Vt&&he){const Y=de(Nt[0]);e.texStorage2D(i.TEXTURE_2D,ht,At,Y.width,Y.height)}for(let Y=0,K=Nt.length;Y<K;Y++)lt=Nt[Y],Vt?P&&e.texSubImage2D(i.TEXTURE_2D,Y,0,0,vt,Ht,lt):e.texImage2D(i.TEXTURE_2D,Y,At,vt,Ht,lt);v.generateMipmaps=!1}else if(Vt){if(he){const Y=de(tt);e.texStorage2D(i.TEXTURE_2D,ht,At,Y.width,Y.height)}P&&e.texSubImage2D(i.TEXTURE_2D,0,0,0,vt,Ht,tt)}else e.texImage2D(i.TEXTURE_2D,0,At,vt,Ht,tt);m(v)&&u(J),St.__version=j.version,v.onUpdate&&v.onUpdate(v)}w.__version=v.version}function V(w,v,H){if(v.image.length!==6)return;const J=Bt(w,v),Z=v.source;e.bindTexture(i.TEXTURE_CUBE_MAP,w.__webglTexture,i.TEXTURE0+H);const j=n.get(Z);if(Z.version!==j.__version||J===!0){e.activeTexture(i.TEXTURE0+H);const St=jt.getPrimaries(jt.workingColorSpace),ot=v.colorSpace===Sn?null:jt.getPrimaries(v.colorSpace),ct=v.colorSpace===Sn||St===ot?i.NONE:i.BROWSER_DEFAULT_WEBGL;i.pixelStorei(i.UNPACK_FLIP_Y_WEBGL,v.flipY),i.pixelStorei(i.UNPACK_PREMULTIPLY_ALPHA_WEBGL,v.premultiplyAlpha),i.pixelStorei(i.UNPACK_ALIGNMENT,v.unpackAlignment),i.pixelStorei(i.UNPACK_COLORSPACE_CONVERSION_WEBGL,ct);const It=v.isCompressedTexture||v.image[0].isCompressedTexture,tt=v.image[0]&&v.image[0].isDataTexture,vt=[];for(let K=0;K<6;K++)!It&&!tt?vt[K]=_(v.image[K],!0,r.maxCubemapSize):vt[K]=tt?v.image[K].image:v.image[K],vt[K]=Ct(v,vt[K]);const Ht=vt[0],At=s.convert(v.format,v.colorSpace),lt=s.convert(v.type),Nt=E(v.internalFormat,At,lt,v.colorSpace),Vt=v.isVideoTexture!==!0,he=j.__version===void 0||J===!0,P=Z.dataReady;let ht=T(v,Ht);gt(i.TEXTURE_CUBE_MAP,v);let Y;if(It){Vt&&he&&e.texStorage2D(i.TEXTURE_CUBE_MAP,ht,Nt,Ht.width,Ht.height);for(let K=0;K<6;K++){Y=vt[K].mipmaps;for(let nt=0;nt<Y.length;nt++){const wt=Y[nt];v.format!==Qe?At!==null?Vt?P&&e.compressedTexSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+K,nt,0,0,wt.width,wt.height,At,wt.data):e.compressedTexImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+K,nt,Nt,wt.width,wt.height,0,wt.data):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .setTextureCube()"):Vt?P&&e.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+K,nt,0,0,wt.width,wt.height,At,lt,wt.data):e.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+K,nt,Nt,wt.width,wt.height,0,At,lt,wt.data)}}}else{if(Y=v.mipmaps,Vt&&he){Y.length>0&&ht++;const K=de(vt[0]);e.texStorage2D(i.TEXTURE_CUBE_MAP,ht,Nt,K.width,K.height)}for(let K=0;K<6;K++)if(tt){Vt?P&&e.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+K,0,0,0,vt[K].width,vt[K].height,At,lt,vt[K].data):e.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+K,0,Nt,vt[K].width,vt[K].height,0,At,lt,vt[K].data);for(let nt=0;nt<Y.length;nt++){const Kt=Y[nt].image[K].image;Vt?P&&e.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+K,nt+1,0,0,Kt.width,Kt.height,At,lt,Kt.data):e.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+K,nt+1,Nt,Kt.width,Kt.height,0,At,lt,Kt.data)}}else{Vt?P&&e.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+K,0,0,0,At,lt,vt[K]):e.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+K,0,Nt,At,lt,vt[K]);for(let nt=0;nt<Y.length;nt++){const wt=Y[nt];Vt?P&&e.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+K,nt+1,0,0,At,lt,wt.image[K]):e.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+K,nt+1,Nt,At,lt,wt.image[K])}}}m(v)&&u(i.TEXTURE_CUBE_MAP),j.__version=Z.version,v.onUpdate&&v.onUpdate(v)}w.__version=v.version}function Q(w,v,H,J,Z,j){const St=s.convert(H.format,H.colorSpace),ot=s.convert(H.type),ct=E(H.internalFormat,St,ot,H.colorSpace);if(!n.get(v).__hasExternalTextures){const tt=Math.max(1,v.width>>j),vt=Math.max(1,v.height>>j);Z===i.TEXTURE_3D||Z===i.TEXTURE_2D_ARRAY?e.texImage3D(Z,j,ct,tt,vt,v.depth,0,St,ot,null):e.texImage2D(Z,j,ct,tt,vt,0,St,ot,null)}e.bindFramebuffer(i.FRAMEBUFFER,w),qt(v)?o.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER,J,Z,n.get(H).__webglTexture,0,Et(v)):(Z===i.TEXTURE_2D||Z>=i.TEXTURE_CUBE_MAP_POSITIVE_X&&Z<=i.TEXTURE_CUBE_MAP_NEGATIVE_Z)&&i.framebufferTexture2D(i.FRAMEBUFFER,J,Z,n.get(H).__webglTexture,j),e.bindFramebuffer(i.FRAMEBUFFER,null)}function pt(w,v,H){if(i.bindRenderbuffer(i.RENDERBUFFER,w),v.depthBuffer){const J=v.depthTexture,Z=J&&J.isDepthTexture?J.type:null,j=S(v.stencilBuffer,Z),St=v.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,ot=Et(v);qt(v)?o.renderbufferStorageMultisampleEXT(i.RENDERBUFFER,ot,j,v.width,v.height):H?i.renderbufferStorageMultisample(i.RENDERBUFFER,ot,j,v.width,v.height):i.renderbufferStorage(i.RENDERBUFFER,j,v.width,v.height),i.framebufferRenderbuffer(i.FRAMEBUFFER,St,i.RENDERBUFFER,w)}else{const J=v.textures;for(let Z=0;Z<J.length;Z++){const j=J[Z],St=s.convert(j.format,j.colorSpace),ot=s.convert(j.type),ct=E(j.internalFormat,St,ot,j.colorSpace),It=Et(v);H&&qt(v)===!1?i.renderbufferStorageMultisample(i.RENDERBUFFER,It,ct,v.width,v.height):qt(v)?o.renderbufferStorageMultisampleEXT(i.RENDERBUFFER,It,ct,v.width,v.height):i.renderbufferStorage(i.RENDERBUFFER,ct,v.width,v.height)}}i.bindRenderbuffer(i.RENDERBUFFER,null)}function it(w,v){if(v&&v.isWebGLCubeRenderTarget)throw new Error("Depth Texture with cube render targets is not supported");if(e.bindFramebuffer(i.FRAMEBUFFER,w),!(v.depthTexture&&v.depthTexture.isDepthTexture))throw new Error("renderTarget.depthTexture must be an instance of THREE.DepthTexture");(!n.get(v.depthTexture).__webglTexture||v.depthTexture.image.width!==v.width||v.depthTexture.image.height!==v.height)&&(v.depthTexture.image.width=v.width,v.depthTexture.image.height=v.height,v.depthTexture.needsUpdate=!0),q(v.depthTexture,0);const J=n.get(v.depthTexture).__webglTexture,Z=Et(v);if(v.depthTexture.format===xi)qt(v)?o.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER,i.DEPTH_ATTACHMENT,i.TEXTURE_2D,J,0,Z):i.framebufferTexture2D(i.FRAMEBUFFER,i.DEPTH_ATTACHMENT,i.TEXTURE_2D,J,0);else if(v.depthTexture.format===bi)qt(v)?o.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER,i.DEPTH_STENCIL_ATTACHMENT,i.TEXTURE_2D,J,0,Z):i.framebufferTexture2D(i.FRAMEBUFFER,i.DEPTH_STENCIL_ATTACHMENT,i.TEXTURE_2D,J,0);else throw new Error("Unknown depthTexture format")}function Ut(w){const v=n.get(w),H=w.isWebGLCubeRenderTarget===!0;if(w.depthTexture&&!v.__autoAllocateDepthBuffer){if(H)throw new Error("target.depthTexture not supported in Cube render targets");it(v.__webglFramebuffer,w)}else if(H){v.__webglDepthbuffer=[];for(let J=0;J<6;J++)e.bindFramebuffer(i.FRAMEBUFFER,v.__webglFramebuffer[J]),v.__webglDepthbuffer[J]=i.createRenderbuffer(),pt(v.__webglDepthbuffer[J],w,!1)}else e.bindFramebuffer(i.FRAMEBUFFER,v.__webglFramebuffer),v.__webglDepthbuffer=i.createRenderbuffer(),pt(v.__webglDepthbuffer,w,!1);e.bindFramebuffer(i.FRAMEBUFFER,null)}function Rt(w,v,H){const J=n.get(w);v!==void 0&&Q(J.__webglFramebuffer,w,w.texture,i.COLOR_ATTACHMENT0,i.TEXTURE_2D,0),H!==void 0&&Ut(w)}function Xt(w){const v=w.texture,H=n.get(w),J=n.get(v);w.addEventListener("dispose",R);const Z=w.textures,j=w.isWebGLCubeRenderTarget===!0,St=Z.length>1;if(St||(J.__webglTexture===void 0&&(J.__webglTexture=i.createTexture()),J.__version=v.version,a.memory.textures++),j){H.__webglFramebuffer=[];for(let ot=0;ot<6;ot++)if(v.mipmaps&&v.mipmaps.length>0){H.__webglFramebuffer[ot]=[];for(let ct=0;ct<v.mipmaps.length;ct++)H.__webglFramebuffer[ot][ct]=i.createFramebuffer()}else H.__webglFramebuffer[ot]=i.createFramebuffer()}else{if(v.mipmaps&&v.mipmaps.length>0){H.__webglFramebuffer=[];for(let ot=0;ot<v.mipmaps.length;ot++)H.__webglFramebuffer[ot]=i.createFramebuffer()}else H.__webglFramebuffer=i.createFramebuffer();if(St)for(let ot=0,ct=Z.length;ot<ct;ot++){const It=n.get(Z[ot]);It.__webglTexture===void 0&&(It.__webglTexture=i.createTexture(),a.memory.textures++)}if(w.samples>0&&qt(w)===!1){H.__webglMultisampledFramebuffer=i.createFramebuffer(),H.__webglColorRenderbuffer=[],e.bindFramebuffer(i.FRAMEBUFFER,H.__webglMultisampledFramebuffer);for(let ot=0;ot<Z.length;ot++){const ct=Z[ot];H.__webglColorRenderbuffer[ot]=i.createRenderbuffer(),i.bindRenderbuffer(i.RENDERBUFFER,H.__webglColorRenderbuffer[ot]);const It=s.convert(ct.format,ct.colorSpace),tt=s.convert(ct.type),vt=E(ct.internalFormat,It,tt,ct.colorSpace,w.isXRRenderTarget===!0),Ht=Et(w);i.renderbufferStorageMultisample(i.RENDERBUFFER,Ht,vt,w.width,w.height),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0+ot,i.RENDERBUFFER,H.__webglColorRenderbuffer[ot])}i.bindRenderbuffer(i.RENDERBUFFER,null),w.depthBuffer&&(H.__webglDepthRenderbuffer=i.createRenderbuffer(),pt(H.__webglDepthRenderbuffer,w,!0)),e.bindFramebuffer(i.FRAMEBUFFER,null)}}if(j){e.bindTexture(i.TEXTURE_CUBE_MAP,J.__webglTexture),gt(i.TEXTURE_CUBE_MAP,v);for(let ot=0;ot<6;ot++)if(v.mipmaps&&v.mipmaps.length>0)for(let ct=0;ct<v.mipmaps.length;ct++)Q(H.__webglFramebuffer[ot][ct],w,v,i.COLOR_ATTACHMENT0,i.TEXTURE_CUBE_MAP_POSITIVE_X+ot,ct);else Q(H.__webglFramebuffer[ot],w,v,i.COLOR_ATTACHMENT0,i.TEXTURE_CUBE_MAP_POSITIVE_X+ot,0);m(v)&&u(i.TEXTURE_CUBE_MAP),e.unbindTexture()}else if(St){for(let ot=0,ct=Z.length;ot<ct;ot++){const It=Z[ot],tt=n.get(It);e.bindTexture(i.TEXTURE_2D,tt.__webglTexture),gt(i.TEXTURE_2D,It),Q(H.__webglFramebuffer,w,It,i.COLOR_ATTACHMENT0+ot,i.TEXTURE_2D,0),m(It)&&u(i.TEXTURE_2D)}e.unbindTexture()}else{let ot=i.TEXTURE_2D;if((w.isWebGL3DRenderTarget||w.isWebGLArrayRenderTarget)&&(ot=w.isWebGL3DRenderTarget?i.TEXTURE_3D:i.TEXTURE_2D_ARRAY),e.bindTexture(ot,J.__webglTexture),gt(ot,v),v.mipmaps&&v.mipmaps.length>0)for(let ct=0;ct<v.mipmaps.length;ct++)Q(H.__webglFramebuffer[ct],w,v,i.COLOR_ATTACHMENT0,ot,ct);else Q(H.__webglFramebuffer,w,v,i.COLOR_ATTACHMENT0,ot,0);m(v)&&u(ot),e.unbindTexture()}w.depthBuffer&&Ut(w)}function D(w){const v=w.textures;for(let H=0,J=v.length;H<J;H++){const Z=v[H];if(m(Z)){const j=w.isWebGLCubeRenderTarget?i.TEXTURE_CUBE_MAP:i.TEXTURE_2D,St=n.get(Z).__webglTexture;e.bindTexture(j,St),u(j),e.unbindTexture()}}}const Wt=[],Gt=[];function oe(w){if(w.samples>0){if(qt(w)===!1){const v=w.textures,H=w.width,J=w.height;let Z=i.COLOR_BUFFER_BIT;const j=w.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,St=n.get(w),ot=v.length>1;if(ot)for(let ct=0;ct<v.length;ct++)e.bindFramebuffer(i.FRAMEBUFFER,St.__webglMultisampledFramebuffer),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0+ct,i.RENDERBUFFER,null),e.bindFramebuffer(i.FRAMEBUFFER,St.__webglFramebuffer),i.framebufferTexture2D(i.DRAW_FRAMEBUFFER,i.COLOR_ATTACHMENT0+ct,i.TEXTURE_2D,null,0);e.bindFramebuffer(i.READ_FRAMEBUFFER,St.__webglMultisampledFramebuffer),e.bindFramebuffer(i.DRAW_FRAMEBUFFER,St.__webglFramebuffer);for(let ct=0;ct<v.length;ct++){if(w.resolveDepthBuffer&&(w.depthBuffer&&(Z|=i.DEPTH_BUFFER_BIT),w.stencilBuffer&&w.resolveStencilBuffer&&(Z|=i.STENCIL_BUFFER_BIT)),ot){i.framebufferRenderbuffer(i.READ_FRAMEBUFFER,i.COLOR_ATTACHMENT0,i.RENDERBUFFER,St.__webglColorRenderbuffer[ct]);const It=n.get(v[ct]).__webglTexture;i.framebufferTexture2D(i.DRAW_FRAMEBUFFER,i.COLOR_ATTACHMENT0,i.TEXTURE_2D,It,0)}i.blitFramebuffer(0,0,H,J,0,0,H,J,Z,i.NEAREST),c===!0&&(Wt.length=0,Gt.length=0,Wt.push(i.COLOR_ATTACHMENT0+ct),w.depthBuffer&&w.resolveDepthBuffer===!1&&(Wt.push(j),Gt.push(j),i.invalidateFramebuffer(i.DRAW_FRAMEBUFFER,Gt)),i.invalidateFramebuffer(i.READ_FRAMEBUFFER,Wt))}if(e.bindFramebuffer(i.READ_FRAMEBUFFER,null),e.bindFramebuffer(i.DRAW_FRAMEBUFFER,null),ot)for(let ct=0;ct<v.length;ct++){e.bindFramebuffer(i.FRAMEBUFFER,St.__webglMultisampledFramebuffer),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0+ct,i.RENDERBUFFER,St.__webglColorRenderbuffer[ct]);const It=n.get(v[ct]).__webglTexture;e.bindFramebuffer(i.FRAMEBUFFER,St.__webglFramebuffer),i.framebufferTexture2D(i.DRAW_FRAMEBUFFER,i.COLOR_ATTACHMENT0+ct,i.TEXTURE_2D,It,0)}e.bindFramebuffer(i.DRAW_FRAMEBUFFER,St.__webglMultisampledFramebuffer)}else if(w.depthBuffer&&w.resolveDepthBuffer===!1&&c){const v=w.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT;i.invalidateFramebuffer(i.DRAW_FRAMEBUFFER,[v])}}}function Et(w){return Math.min(r.maxSamples,w.samples)}function qt(w){const v=n.get(w);return w.samples>0&&t.has("WEBGL_multisampled_render_to_texture")===!0&&v.__useRenderToTexture!==!1}function Ft(w){const v=a.render.frame;h.get(w)!==v&&(h.set(w,v),w.update())}function Ct(w,v){const H=w.colorSpace,J=w.format,Z=w.type;return w.isCompressedTexture===!0||w.isVideoTexture===!0||H!==Pn&&H!==Sn&&(jt.getTransfer(H)===ie?(J!==Qe||Z!==wn)&&console.warn("THREE.WebGLTextures: sRGB encoded textures have to use RGBAFormat and UnsignedByteType."):console.error("THREE.WebGLTextures: Unsupported texture color space:",H)),v}function de(w){return typeof HTMLImageElement<"u"&&w instanceof HTMLImageElement?(l.width=w.naturalWidth||w.width,l.height=w.naturalHeight||w.height):typeof VideoFrame<"u"&&w instanceof VideoFrame?(l.width=w.displayWidth,l.height=w.displayHeight):(l.width=w.width,l.height=w.height),l}this.allocateTextureUnit=k,this.resetTextureUnits=L,this.setTexture2D=q,this.setTexture2DArray=X,this.setTexture3D=G,this.setTextureCube=$,this.rebindTextures=Rt,this.setupRenderTarget=Xt,this.updateRenderTargetMipmap=D,this.updateMultisampleRenderTarget=oe,this.setupDepthRenderbuffer=Ut,this.setupFrameBufferTexture=Q,this.useMultisampledRTT=qt}function xm(i,t){function e(n,r=Sn){let s;const a=jt.getTransfer(r);if(n===wn)return i.UNSIGNED_BYTE;if(n===Qo)return i.UNSIGNED_SHORT_4_4_4_4;if(n===tc)return i.UNSIGNED_SHORT_5_5_5_1;if(n===Hl)return i.UNSIGNED_INT_5_9_9_9_REV;if(n===Bl)return i.BYTE;if(n===zl)return i.SHORT;if(n===Dr)return i.UNSIGNED_SHORT;if(n===jo)return i.INT;if(n===Ei)return i.UNSIGNED_INT;if(n===yn)return i.FLOAT;if(n===Gr)return i.HALF_FLOAT;if(n===kl)return i.ALPHA;if(n===Gl)return i.RGB;if(n===Qe)return i.RGBA;if(n===Vl)return i.LUMINANCE;if(n===Wl)return i.LUMINANCE_ALPHA;if(n===xi)return i.DEPTH_COMPONENT;if(n===bi)return i.DEPTH_STENCIL;if(n===Xl)return i.RED;if(n===ec)return i.RED_INTEGER;if(n===ql)return i.RG;if(n===nc)return i.RG_INTEGER;if(n===ic)return i.RGBA_INTEGER;if(n===ts||n===es||n===ns||n===is)if(a===ie)if(s=t.get("WEBGL_compressed_texture_s3tc_srgb"),s!==null){if(n===ts)return s.COMPRESSED_SRGB_S3TC_DXT1_EXT;if(n===es)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT1_EXT;if(n===ns)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT3_EXT;if(n===is)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT5_EXT}else return null;else if(s=t.get("WEBGL_compressed_texture_s3tc"),s!==null){if(n===ts)return s.COMPRESSED_RGB_S3TC_DXT1_EXT;if(n===es)return s.COMPRESSED_RGBA_S3TC_DXT1_EXT;if(n===ns)return s.COMPRESSED_RGBA_S3TC_DXT3_EXT;if(n===is)return s.COMPRESSED_RGBA_S3TC_DXT5_EXT}else return null;if(n===ga||n===_a||n===va||n===xa)if(s=t.get("WEBGL_compressed_texture_pvrtc"),s!==null){if(n===ga)return s.COMPRESSED_RGB_PVRTC_4BPPV1_IMG;if(n===_a)return s.COMPRESSED_RGB_PVRTC_2BPPV1_IMG;if(n===va)return s.COMPRESSED_RGBA_PVRTC_4BPPV1_IMG;if(n===xa)return s.COMPRESSED_RGBA_PVRTC_2BPPV1_IMG}else return null;if(n===Ma||n===Sa||n===ya)if(s=t.get("WEBGL_compressed_texture_etc"),s!==null){if(n===Ma||n===Sa)return a===ie?s.COMPRESSED_SRGB8_ETC2:s.COMPRESSED_RGB8_ETC2;if(n===ya)return a===ie?s.COMPRESSED_SRGB8_ALPHA8_ETC2_EAC:s.COMPRESSED_RGBA8_ETC2_EAC}else return null;if(n===Ea||n===Ta||n===ba||n===Aa||n===wa||n===Ra||n===Ca||n===Pa||n===La||n===Da||n===Ua||n===Ia||n===Na||n===Fa)if(s=t.get("WEBGL_compressed_texture_astc"),s!==null){if(n===Ea)return a===ie?s.COMPRESSED_SRGB8_ALPHA8_ASTC_4x4_KHR:s.COMPRESSED_RGBA_ASTC_4x4_KHR;if(n===Ta)return a===ie?s.COMPRESSED_SRGB8_ALPHA8_ASTC_5x4_KHR:s.COMPRESSED_RGBA_ASTC_5x4_KHR;if(n===ba)return a===ie?s.COMPRESSED_SRGB8_ALPHA8_ASTC_5x5_KHR:s.COMPRESSED_RGBA_ASTC_5x5_KHR;if(n===Aa)return a===ie?s.COMPRESSED_SRGB8_ALPHA8_ASTC_6x5_KHR:s.COMPRESSED_RGBA_ASTC_6x5_KHR;if(n===wa)return a===ie?s.COMPRESSED_SRGB8_ALPHA8_ASTC_6x6_KHR:s.COMPRESSED_RGBA_ASTC_6x6_KHR;if(n===Ra)return a===ie?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x5_KHR:s.COMPRESSED_RGBA_ASTC_8x5_KHR;if(n===Ca)return a===ie?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x6_KHR:s.COMPRESSED_RGBA_ASTC_8x6_KHR;if(n===Pa)return a===ie?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x8_KHR:s.COMPRESSED_RGBA_ASTC_8x8_KHR;if(n===La)return a===ie?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x5_KHR:s.COMPRESSED_RGBA_ASTC_10x5_KHR;if(n===Da)return a===ie?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x6_KHR:s.COMPRESSED_RGBA_ASTC_10x6_KHR;if(n===Ua)return a===ie?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x8_KHR:s.COMPRESSED_RGBA_ASTC_10x8_KHR;if(n===Ia)return a===ie?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x10_KHR:s.COMPRESSED_RGBA_ASTC_10x10_KHR;if(n===Na)return a===ie?s.COMPRESSED_SRGB8_ALPHA8_ASTC_12x10_KHR:s.COMPRESSED_RGBA_ASTC_12x10_KHR;if(n===Fa)return a===ie?s.COMPRESSED_SRGB8_ALPHA8_ASTC_12x12_KHR:s.COMPRESSED_RGBA_ASTC_12x12_KHR}else return null;if(n===rs||n===Oa||n===Ba)if(s=t.get("EXT_texture_compression_bptc"),s!==null){if(n===rs)return a===ie?s.COMPRESSED_SRGB_ALPHA_BPTC_UNORM_EXT:s.COMPRESSED_RGBA_BPTC_UNORM_EXT;if(n===Oa)return s.COMPRESSED_RGB_BPTC_SIGNED_FLOAT_EXT;if(n===Ba)return s.COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT_EXT}else return null;if(n===Yl||n===za||n===Ha||n===ka)if(s=t.get("EXT_texture_compression_rgtc"),s!==null){if(n===rs)return s.COMPRESSED_RED_RGTC1_EXT;if(n===za)return s.COMPRESSED_SIGNED_RED_RGTC1_EXT;if(n===Ha)return s.COMPRESSED_RED_GREEN_RGTC2_EXT;if(n===ka)return s.COMPRESSED_SIGNED_RED_GREEN_RGTC2_EXT}else return null;return n===Ti?i.UNSIGNED_INT_24_8:i[n]!==void 0?i[n]:null}return{convert:e}}class Mm extends Be{constructor(t=[]){super(),this.isArrayCamera=!0,this.cameras=t}}class gi extends Se{constructor(){super(),this.isGroup=!0,this.type="Group"}}const Sm={type:"move"};class Cs{constructor(){this._targetRay=null,this._grip=null,this._hand=null}getHandSpace(){return this._hand===null&&(this._hand=new gi,this._hand.matrixAutoUpdate=!1,this._hand.visible=!1,this._hand.joints={},this._hand.inputState={pinching:!1}),this._hand}getTargetRaySpace(){return this._targetRay===null&&(this._targetRay=new gi,this._targetRay.matrixAutoUpdate=!1,this._targetRay.visible=!1,this._targetRay.hasLinearVelocity=!1,this._targetRay.linearVelocity=new A,this._targetRay.hasAngularVelocity=!1,this._targetRay.angularVelocity=new A),this._targetRay}getGripSpace(){return this._grip===null&&(this._grip=new gi,this._grip.matrixAutoUpdate=!1,this._grip.visible=!1,this._grip.hasLinearVelocity=!1,this._grip.linearVelocity=new A,this._grip.hasAngularVelocity=!1,this._grip.angularVelocity=new A),this._grip}dispatchEvent(t){return this._targetRay!==null&&this._targetRay.dispatchEvent(t),this._grip!==null&&this._grip.dispatchEvent(t),this._hand!==null&&this._hand.dispatchEvent(t),this}connect(t){if(t&&t.hand){const e=this._hand;if(e)for(const n of t.hand.values())this._getHandJoint(e,n)}return this.dispatchEvent({type:"connected",data:t}),this}disconnect(t){return this.dispatchEvent({type:"disconnected",data:t}),this._targetRay!==null&&(this._targetRay.visible=!1),this._grip!==null&&(this._grip.visible=!1),this._hand!==null&&(this._hand.visible=!1),this}update(t,e,n){let r=null,s=null,a=null;const o=this._targetRay,c=this._grip,l=this._hand;if(t&&e.session.visibilityState!=="visible-blurred"){if(l&&t.hand){a=!0;for(const _ of t.hand.values()){const m=e.getJointPose(_,n),u=this._getHandJoint(l,_);m!==null&&(u.matrix.fromArray(m.transform.matrix),u.matrix.decompose(u.position,u.rotation,u.scale),u.matrixWorldNeedsUpdate=!0,u.jointRadius=m.radius),u.visible=m!==null}const h=l.joints["index-finger-tip"],d=l.joints["thumb-tip"],p=h.position.distanceTo(d.position),f=.02,g=.005;l.inputState.pinching&&p>f+g?(l.inputState.pinching=!1,this.dispatchEvent({type:"pinchend",handedness:t.handedness,target:this})):!l.inputState.pinching&&p<=f-g&&(l.inputState.pinching=!0,this.dispatchEvent({type:"pinchstart",handedness:t.handedness,target:this}))}else c!==null&&t.gripSpace&&(s=e.getPose(t.gripSpace,n),s!==null&&(c.matrix.fromArray(s.transform.matrix),c.matrix.decompose(c.position,c.rotation,c.scale),c.matrixWorldNeedsUpdate=!0,s.linearVelocity?(c.hasLinearVelocity=!0,c.linearVelocity.copy(s.linearVelocity)):c.hasLinearVelocity=!1,s.angularVelocity?(c.hasAngularVelocity=!0,c.angularVelocity.copy(s.angularVelocity)):c.hasAngularVelocity=!1));o!==null&&(r=e.getPose(t.targetRaySpace,n),r===null&&s!==null&&(r=s),r!==null&&(o.matrix.fromArray(r.transform.matrix),o.matrix.decompose(o.position,o.rotation,o.scale),o.matrixWorldNeedsUpdate=!0,r.linearVelocity?(o.hasLinearVelocity=!0,o.linearVelocity.copy(r.linearVelocity)):o.hasLinearVelocity=!1,r.angularVelocity?(o.hasAngularVelocity=!0,o.angularVelocity.copy(r.angularVelocity)):o.hasAngularVelocity=!1,this.dispatchEvent(Sm)))}return o!==null&&(o.visible=r!==null),c!==null&&(c.visible=s!==null),l!==null&&(l.visible=a!==null),this}_getHandJoint(t,e){if(t.joints[e.jointName]===void 0){const n=new gi;n.matrixAutoUpdate=!1,n.visible=!1,t.joints[e.jointName]=n,t.add(n)}return t.joints[e.jointName]}}const ym=`
void main() {
